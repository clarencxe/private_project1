...
void b_conv(const omlsa_float32_t A_data[], omlsa_float32_t C_data[], int C_size[1])
{
  ...
  omlsa_float32_t s;
  int k;
  static const omlsa_float32_t B[3] = { 0.24999999999999997, 0.5, 0.24999999999999997 };
...
void c_conv(const omlsa_float32_t A_data[], omlsa_float32_t C_data[], int C_size[1])
{
  ...
  omlsa_float32_t s;
  int k;
  static const omlsa_float32_t B[31] = { 0.000600459987399049, 0.0023787646090222894,
